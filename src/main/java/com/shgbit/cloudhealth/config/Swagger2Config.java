...
public class Swagger2Config {
    ...
    private static final String DEFAULT_PATH = "cloudhealth-api";
...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .apis(RequestHandlerSelectors.basePackage("com.shgbit.cloudhealth.controller"))
